...
Clockwork.animation.stored.FalloutHuman = {
    ["crouch_idle"] = "2haaim",
    ["crouch_walk"] = "2haaim_walk",
    ["stand_idle"] = "1hmaim",
    ["stand_walk"] = "1hmwalk",
    ["stand_run"] = "1hmaim_run",
    ["sit"] = ACT_BUSY_SIT_CHAIR,
    ["crouch_grenade_aim_idle"] = "sneakmtidle", 
    ["crouch_grenade_aim_walk"] = "sneakmtwalk",
    ["stand_grenade_aim_idle"] = "mtidle",
    ["stand_grenade_aim_walk"] = ACT_WALK,
    ["stand_grenade_aim_run"] = ACT_RUN,
    ["crouch_grenade_walk"] = "sneakmtwalk",
    ["crouch_grenade_idle"] = "sneakmtidle",
    ["stand_grenade_walk"] = "1gtaim_walk",
    ["stand_grenade_idle"] = "1gtaim",
    ["stand_grenade_run"] = "1gtaim_run",
    ["grenade_attack"] = "1gtattackthrow",
    ["crouch_smg_aim_walk"] = "2haaimis_sneak",
    ["crouch_smg_aim_idle"] = "sneak2haaimis",
    ["stand_smg_aim_idle"] = "2haaimis",
    ["stand_smg_aim_walk"] = "2haaimis_walk",
    ["stand_smg_aim_run"] = "2haaimis_run",
    ["crouch_smg_walk"] = "2haaimis_sneak",
    ["crouch_smg_idle"] = "sneak2haaimis",
    ["stand_smg_idle"] = "2haaimis",
    ["stand_smg_walk"] = "2haaimis_walk",
    ["stand_smg_run"] = "2haaimis_run",
    ["smg_attack"] = "2haattack4is",
    ["smg_reload"] = "2hareloadi",
    ["crouch_pistol_aim_idle"] = "sneak1hpaim", 
    ["crouch_pistol_aim_walk"] = "1hpaim_sneak",
    ["stand_pistol_aim_walk"] = "1hpaim_walk",
    ["stand_pistol_aim_idle"] = "1hpaim",
    ["stand_pistol_aim_run"] = "1hpaim_run",
    ["crouch_pistol_idle"] = "sneakmtidle",
    ["crouch_pistol_walk"] = "sneakmtwalk",
    ["stand_pistol_walk"] = ACT_WALK,
    ["stand_pistol_idle"] = "mtidle",
    ["stand_pistol_run"] = ACT_RUN,
    ["pistol_attack"] = ACT_GESTURE_RANGE_ATTACK_PISTOL_LOW,
    ["pistol_reload"] = "1hpreloada",
    ["stand_fist_aim_run"] = ACT_RUN,
    ["stand_fist_aim_walk"] = ACT_WALK,
    ["stand_fist_aim_idle"] = "mtidle",
    ["crouch_idle"] = "2haaim_sneak",
    ["crouch_walk"] = "2haaim_sneakfast",
    ["jump"] = "mtjumploop",
    ["crouch_fist_aim_idle"] = "sneakmtidle",
    ["crouch_fist_aim_walk"] = "sneakmtwalk",
    ["stand_blunt_aim_idle"] =  "h2haim",
    ["stand_blunt_aim_walk"] = "h2haim_walk",
    ["stand_blunt_aim_run"] = "h2haim_run",
    ["crouch_blunt_aim_walk"] = "sneakh2haim",
    ["crouch_blunt_aim_idle"] = "h2haim_sneak",
    ["stand_heavy_idle"] = "2haaim",
    ["stand_heavy_walk"] = "2haaim_walk",
    ["stand_heavy_run"] = "2haaim_run",
    ["stand_smg_idle"] =  "2hhaim",
    ["stand_smg_walk"] = "2hhaim_walk",
    ["stand_smg_run"] = "2hhaim_run",
    ["stand_pistol_idle"] = "1hpaim",
    ["stand_pistol_walk"] = "1hpaim_walk",
    ["stand_pistol_run"] = "1hpaim_run",
    ["crouch_heavy_walk"] = "2hlaim_sneak",
    ["crouch_heavy_idle"] = "sneak2hlaim",
    ["stand_smg_walk"] = "2haaim_walk",
    ["stand_pistol_idle"] = "2haaim",
    ["stand_pistol_run"] = "2haaim_run",
    ["stand_smg_idle"] =  "2hraim",
    ["stand_smg_walk"] = "2hraim_walk",
    ["stand_smg_run"] = "2hrrun",
    ["crouch_smg_walk"] = "sneak2hraim",
    ["crouch_smg_idle"] = "2hraim_sneak",
    ["stand_heavy_walk"] = "2hlaim_walk",
    ["stand_heavy_idle"] = "2hlaim",
    ["stand_heavy_run"] = "2hlaim_run",
    ["stand_smg_idle"] =  "2haaimis",
    ["stand_smg_walk"] = "2haaimis_walk",
    ["stand_smg_run"] = "2haaimis_run",
    ["crouch_smg_walk"] = "2haaimis_sneak",
    ["crouch_smg_idle"] = "sneak2haaimis",
    ["stand_heavy_idle"] = "2hraimis",
    ["stand_heavy_walk"] = "2hraimis_walk",
    ["stand_heavy_run"] = "2hraimis_run",
    ["crouch_heavy_walk"] = "sneak2hraimis",
    ["crouch_heavy_idle"] = "2hraimis_sneak",
    ["walk_revolver"] = "2hraim_walk",
    ["idle_revolver"] = "2hraim",
    ["run_revolver"] = "2hrrun",
    ["cwalk_revolver"] = "sneak2hraim",
    ["cidle_revolver"] = "2hraim_sneak",
    ["stand_fist_idle"] = "mtidle",
    ["stand_fist_walk"] = ACT_WALK,
    ["stand_fist_run"] = ACT_RUN,
    ["crouch_fist_walk"] = "sneakmtwalk",
    ["crouch_fist_idle"] = "sneakmtidle",
    ["stand_fist_aim_idle"] = "h2haim",
    ["stand_fist_aim_walk"] = "h2haim_walk",
    ["stand_fist_aim_run"] = "h2haim_run",
    ["crouch_fist_aim_walk"] = "h2haim_sneak",
    ["crouch_fist_aim_idle"] = "sneakh2haim"
};
...
function Clockwork.animation:AddFalloutHumanModel(model)
    return self:AddModel("FalloutHuman", model);
end;

Clockwork.animation:AddFalloutHumanModel("models/fallout/player/caesar.mdl");
