...
if (SERVER) then
	...
	Clockwork.limb.bodyTexture = Material("atomic/hud/body/body.png");
	Clockwork.limb.stored = Clockwork.limb.stored or {};
	Clockwork.limb.hitGroups = {
		[HITGROUP_RIGHTARM] = Material("atomic/hud/body/rarm.png"),
		[HITGROUP_RIGHTLEG] = Material("atomic/hud/body/rleg.png"),
		[HITGROUP_LEFTARM] = Material("atomic/hud/body/larm.png"),
		[HITGROUP_LEFTLEG] = Material("atomic/hud/body/lleg.png"),
		[HITGROUP_STOMACH] = Material("atomic/hud/body/stomach.png"),
		[HITGROUP_CHEST] = Material("atomic/hud/body/chest.png"),
		[HITGROUP_HEAD] = Material("atomic/hud/body/head.png")
	};
	...
	function Clockwork.limb:GetColor(info)
		local infoColor = Clockwork.option:GetColor("information");
		local colors = Color(infoColor.r, infoColor.g, infoColor.b, info.alpha);
		if (colors) then
			return colors
		end;	
	end;
