...
Clockwork.chatBox:RegisterDefaultClass("ic", "ic", function(info)
	if (info.shouldHear) then
		...
		Clockwork.chatBox:Add(info.filtered, nil, Color(50, 255, 50, 255), "[IC] ", classColor, info.name, " says:\"", info.text.."\"");
	end;
end);
...
Clockwork.chatBox:RegisterDefaultClass("yell", "ic", function(info)
	...
	Clockwork.chatBox:Add(info.filtered, nil, Color(50, 255, 50, 255), "[IC] ", classColor, info.name, " yells:\"", info.text.."\"");
end);
...
Clockwork.chatBox:RegisterDefaultClass("whisper", "ic", function(info)
	if (info.shouldHear) then
		...
		Clockwork.chatBox:Add(info.filtered, nil, Color(50, 255, 50, 255), "[IC] ", classColor, info.name, " whispers:\"", info.text.."\"");
	end;
end);
...
Clockwork.chatBox:RegisterDefaultClass("looc", "ooc", function(info)
	...
	Clockwork.chatBox:Add(info.filtered, info.icon, Color(225, 50, 50, 255), "[LOOC] ", classColor, info.name, ": ", info.text);
end);
...
Clockwork.chatBox:RegisterDefaultClass("rollchar", "ooc", function(info)
	if (info.shouldHear) then
		Clockwork.chatBox:Add(info.filtered, nil, Color(75, 150, 75, 255), "** "..info.name.." "..info.text);
	end;
end);
...
Clockwork.chatBox:RegisterDefaultClass("ncrpass", "ic", function(info)
	local color = Color(255, 69, 0, 255);
