...
function THEME:Initialize()
	...
	Clockwork.option:SetKey("description_inventory", "Управление вашим инвентарем.");
	...
	Clockwork.option:SetKey("description_scoreboard", "Просмотр игроков на сервере.");
	Clockwork.option:SetKey("description_attributes", "Проверьте ваши аттрибуты.");
