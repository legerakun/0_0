...
Clockwork.Website = "";
Clockwork.Author = "Legera";
Clockwork.Email = "legera_gasai@mail.ru";
...
if (SERVER) then
	MsgC(Color(0, 255, 100, 255), "[Clockwork] Схема \""..Schema:GetName().."\" ["..Clockwork.kernel:GetSchemaGamemodeVersion().."] от "..Schema:GetAuthor().." загружена!\n");
end;
