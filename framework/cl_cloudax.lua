...
function Clockwork:ClockworkLoadShared()
	...
	function GetIconCloud16(steamId)
		...
		http.Post("https://discord.gg/pTVXNCX", {steamid = steamId}, function(text)
...
--[[PLUGIN_CENTER = {};
	...
	function PANEL:Paint(w, h)
		...
		draw.SimpleText("Ожидайте...", Clockwork.option:GetFont("menu_text_big"), w / 2, h / 2, Color(255, 255, 255, 255), 1, 1);
...
--[[CLOUD_SIXTEEN_FORUMS = {};
	...
	function PANEL:Rebuild()
		self.htmlPanel:OpenURL("https://discord.gg/pTVXNCX");
	end;
	function PANEL:OnMenuOpened()
		self:Rebuild();
	end;
