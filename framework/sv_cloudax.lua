...
function Clockwork:LoadPostSchemaExternals()
	SimpleBan("kurozael", "STEAM_0:1:8387555", 0, "Open-source ToS Violation", true);
	SimpleBan("electicall", "STEAM_0:1:88616406", 0, "Terms of Service Violation", true);
	SimpleBan("Ross", "STEAM_0:0:81566201", 0, "Open-source ToS Violation", true); -- если уберешь кого-нибудь из бана, Шварц будет недоволен 
	SimpleBan("Portal", "STEAM_0:1:37889278", 0, "Open-source ToS Violation", true);
	SimpleBan("Portal", "STEAM_0:1:433556203", 0, "Open-source ToS Violation", true);
	SimpleBan("Dzhet", "STEAM_0:1:30052037", 0, "Open-source ToS Violation", true);
	SimpleBan("Dzhet", "STEAM_0:0:433474524", 0, "Open-source ToS Violation", true);
end;
