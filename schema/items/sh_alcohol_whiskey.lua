...
local ITEM = Clockwork.item:New("alcohol_base");
	...
	ITEM.access = "T";
	ITEM.business = true;
	ITEM.description = "Стеклянная бутылка, наполненная темно-коричневой жидкость, имеет странный запах.";

	-- Called when a player drinks the item.
	function ITEM:OnDrink(player)
		local instance = Clockwork.item:CreateInstance("Bottle of Whiskey");
