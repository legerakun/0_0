...
local ITEM = Clockwork.item:New("weapon_base");
	...
	ITEM.business = true;
	ITEM.category = "Melee";
	ITEM.weaponClass = "cw_hatchet";
	ITEM.description = "It is a hand-axe with a rubber-gripped wooden handle for chopping wood and limbs alike.";
