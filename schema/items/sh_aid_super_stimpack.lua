...
local ITEM = Clockwork.item:New("base_heal");
    ...
    ITEM.uniqueID = "super_stimpack";
	ITEM.batch = 1;
	ITEM.model = "models/stimpak.mdl";
	ITEM.weight = 0.7;
	ITEM.useText = "Применить";
	ITEM.description = "Медицинский стимулятор, спереди написано 'Супер', по бокам прекреплены ремни.";
	ITEM.baseHeal = 0;
	...
	function ITEM:OnUse(player, itemEntity)
		...
		if (maxhealth) then
			healcount = maxhealth * (0.6 + (atrmed / 100));
