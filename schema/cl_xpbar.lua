...
surface.SetDrawColor( GameColor )
...
hook.Call("clockwork_XPBar_Open",GAMEMODE,self)
end
...
--
draw.SimpleText(self.Level, "Monofonto", self:GetWide() *.0125, self:GetTall() *.425, GameColor, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
draw.SimpleText(self.Level + 1, "Monofonto", self:GetWide() *.91, self:GetTall() *.425, GameColor, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
end

vgui.Register("clockwork_XPBar", PANEL, "DFrame")]]